    ...
    switch (currentMediaType) {
        ...
        case XHBubbleMessageMediaTypeEmotion: {
            ...
            if (currentMediaType == XHBubbleMessageMediaTypeText) {
                UITapGestureRecognizer *tapDoubleGestureRecognizer;
                tapDoubleGestureRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(doubleTapGestureRecognizerHandle:)];
                tapDoubleGestureRecognizer.numberOfTapsRequired = 2;
                [self.messageBubbleView.bubbleImageView addGestureRecognizer:tapDoubleGestureRecognizer];
            }
//            else {
                tapGestureRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(sigleTapGestureRecognizerHandle:)];
//            }
            tapGestureRecognizer.numberOfTapsRequired = 1;//= (currentMediaType == XHBubbleMessageMediaTypeText ? 2 : 1);
